...
module.exports = (app) => {
        ...
        app.delete("/api/v1/user/deleteCart", [auth.userAuthMiddleware], controller.deleteCart);
        app.put("/api/v1/user/deleteItemsfromCart/:cartItemId", [auth.userAuthMiddleware], controller.deleteItemsfromCart);
